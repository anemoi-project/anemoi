/* Native Q128xK64 INT8/E4M3 control using the optimized SM89 mainloop. */
...
template void launch_mixed_attention_sm89_q128_k64<128, true, false, false>(
...
template void launch_mixed_attention_sm89_q128_k64<128, true, true, false>(
    int8_t*, int8_t*, __nv_fp8_e4m3*, half*, half*, half*, half*, half*,
    int32_t*, int32_t*, int32_t*, int32_t*, float*, float*, float*,
    const int32_t*, float*, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t,
    uint32_t, uint32_t, float, cudaStream_t);
