...
// Project-owned localization of the native SM120 NVFP4 instruction used by
// Anemoi commit 8551120418d1af149bbb3ce0bfb33b23ce7cec8d.  Scale vectors contain
// four UE4M3 selectors for each D16 group; tensor-global scales are applied at
// the precision-phase boundary rather than inside this instruction.
__device__ __forceinline__ void mma_m16n8k64_nvfp4(
    const uint32_t (&A)[4],
    const uint32_t (&B)[2],
    uint32_t scale_a,
    uint32_t scale_b,
