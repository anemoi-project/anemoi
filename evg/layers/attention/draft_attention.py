...
from evg.layers.attention.draft_map import DraftMapConfig, DraftMask, build_draft_mask
from evg.layers.attention.sparse_attention import block_sparse_attention, dense_attention_reference
